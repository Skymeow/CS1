...
'''
    ...
    def write_metadata(self, pop_size, vacc_percentage, virus_name, mortality_rate, basic_repro_num):
        ...
        # pop_size = 10000
        # vacc_percentage = 98
        # virus_name = 'Anthrax (untreated)'
        # mortality_rate = virus_list['Anthrax (untreated)'][0]*0.01
        # basic_repro_num = 100
    ...
    def log_interaction(self, person1, person2, did_infect=None, person2_vacc=None, person2_sick=None):
        ...
        with open(self.file_name, "a") as file:
            file.write("{person1._id} infects {person2._id}")
            if person2.is_vaccinated == True:
                file.write("{person1._id} didn't infect {person2._id} because vaccinated")
            elif person2.infection != None:
                file.write("{person1._id} didn't infect {person2._id} because already sick")
